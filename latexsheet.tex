...
%\setlength{\columnseprule}{0.25pt}
        ...
        \end{lstlisting}
        % Razor: not sure if makes sense to add this default information here regarrding @RenderBody() and @RenderSecction("scripts", required: false)...
