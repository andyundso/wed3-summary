...
%\setlength{\columnseprule}{0.25pt}
        ...
        \textbf{Reactive (or model-driven) forms}: Import von \lstlinline{ReactiveFormsModule} nötig, Form und Validations werden im Controller gebaut, mehrere asynchrone Validierungen möglich.
