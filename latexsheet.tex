...
\lstdefinelanguage{JavaScript}{
    keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, @Injectable, @NgModule, @Component, constructor, public, private, @Pipe, const, var, let, async, await},
